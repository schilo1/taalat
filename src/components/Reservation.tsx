      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl mx-auto items-center">
        ...
        >
          ...
          <div className="space-y-3 mt-6">
            <button
              type="submit"
              className="w-full p-5 bg-[#25D366] text-white font-montserrat text-xs tracking-[3px] uppercase hover:bg-[#128C7E] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3"
            >
            ...
            <a
              href="https://yango.go.link/external?service=eats&href=/restaurant/chez_talaat_2_plateaux_hr924?utm_campaign=yangodeli_app_ios&utm_medium=referral&utm_source=rst_shared_link"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full p-5 bg-[#ff0000] text-black font-montserrat text-xs tracking-[3px] uppercase hover:bg-[#e60000] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3"
            >
              {/* <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" />
              </svg> */}
              Commander sur Yango Deli
            </a>

            <a
              href="https://glovo.go.link/open?adjust_deeplink=glovoapp%3A%2F%2Fopen%3Flink_type%3Dstore%26store_id%3D42730&adjust_t=s321jkn"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full p-5 bg-[#ffff44] text-black font-montserrat text-xs tracking-[3px] uppercase hover:bg-[#ffff44] hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3"
            >
              {/* <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5zm0 2.18l8 3.6v8.72c0 4.54-3.08 8.76-7.5 9.94-.22.06-.45.08-.5.08s-.28-.02-.5-.08C7.58 24.26 4.5 20.04 4.5 15.5V7.78l7.5-3.6z" />
              </svg> */}
              Commander sur Glovo
            </a>
          </div>
        ...
        <div className="fade-in">
          ...
          <p className="text-lg text-white/80 mb-8">
            Passez votre commande directement via WhatsApp, Yango Deli ou Glovo
            et recevez vos plats libanais préférés chez vous !
          </p>
